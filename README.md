...
![Version](https://img.shields.io/badge/version-v2.0.2-orange.svg)
...
Download `bemudex_2.0.2_amd64.deb` from the [Releases](https://github.com/vish-1109/Bemudex/releases) page and install it:
```bash
sudo dpkg -i bemudex_2.0.2_amd64.deb
